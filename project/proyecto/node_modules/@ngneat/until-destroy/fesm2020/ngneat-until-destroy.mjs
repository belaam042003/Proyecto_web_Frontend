import { Subject, Subscription, from, EMPTY, asapScheduler } from 'rxjs';
import { ɵNG_PIPE_DEF, ɵgetLContext, ɵglobal } from '@angular/core';
import { mergeMap, observeOn, catchError, takeUntil } from 'rxjs/operators';
...
function setupSubjectUnsubscribedChecker(instance, destroy$) {
    ...
    }), observeOn(asapScheduler), catchError(() => EMPTY))
        .subscribe(() => {
